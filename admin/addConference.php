  ...
  if(empty($error)){
    ...
    // die($ver['a']);
      ...
      //$new['type'] = 1;
        $new['image'] = $ver['a'];
      $post = $new + $_POST ;
    insert($conn, 'conference', $post);
    $message = "Successfull added";
  header("Location:viewConference.php?success=$message");
...
<!-- Page Content -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Leadership Conference</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="index.php">Dashboard</a></li>
                            <li class="active">Add Leadership Conference</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    ...
    <div class="col-md-12">
          <div class="white-box">
            <h3 class="box-title">New Leadership Conference</h3>
          </div>
