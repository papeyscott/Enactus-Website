...
if(array_key_exists('submit', $_POST)){
  ...
  if(!in_array($_FILES['upload']['type'], $ext)){
    $error['upload'] = " Please Upload Boards image";
  }
  if(empty($_POST['name'])){
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Boards</h4> </div>
...
<form class="needs-validation" action="" method="post" enctype="multipart/form-data">
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" class="form-control" id="validationCustom01" placeholder="Directors name"  required>
              </div>

              <div class="col-md-6 mb-3">
                <label for="validationCustom02">Positon</label>
                  <div class="text-danger">
                    <?php $display = displayErrors($error, 'position');
                    echo $display ?>
                  </div>
                <input type="text" name="position" class="form-control" id="validationCustom01" placeholder="position"  required>
              </div>

              <div class="col-md-6 mb-3">
                <label for="validationCustom02">Designation</label>
                  <div class="text-danger">
                    <?php $display = displayErrors($error, 'designation');
                    echo $display ?>
                  </div>
                <input type="text" name="designation" class="form-control" id="validationCustom01" placeholder="designation"  required>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="company" class="form-control" id="validationCustom01" placeholder="company"  required>
              </div>
