...
if(empty($error)){
  ...
  $new['id'] = $_GET['vdata'];
    update($conn,'alumni',$clean,'id',$new,$_GET['ret']);
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Alumni Profile</h4> </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="user-btm-box">
                                <div class="col-md-4 col-sm-4 text-center">
                                    ...
                                    <h1><?php echo $value['email'] ?></h1> </div>
                        ...
                        <div class="white-box">
                            <form action="" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  name="email" value="<?php echo $value['email'] ?>" class="form-control form-control-line"  id="example-email"> </div>
                                </div>
