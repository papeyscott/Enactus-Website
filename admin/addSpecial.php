  ...
  if(empty($error)){
    ...
    // die($ver['a']);
      ...
      //$new['type'] = 1;
        $new['image'] = $ver['a'];
      $post = $new + $_POST ;
    insert($conn, 'special', $post);
    $message = "Successfull added";
  header("Location:viewSpecial.php?success=$message");
...
<!-- Page Content -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Special Projects</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                        <ol class="breadcrumb">
                            <li><a href="index.php">Dashboard</a></li>
                            <li class="active">Add Special Projects</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    ...
    <div class="col-md-12">
          <div class="white-box">
            <h3 class="box-title">New Special Projects</h3>
          </div>
